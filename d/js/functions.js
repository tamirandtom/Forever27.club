...
//if (QueryString.sort == 'year') { lines.sort(sortBy(3));}
    ...
    for (var l=1; l<lines.length; l++) {
      FBShare="<a class='fbshare' href='https://www.facebook.com/sharer/sharer.php?u=http://davidbowie.work/?id="+l+"' target='_blank'>Share on Facebook</a>";
      $( "#itemlist" ).append( '<li class="linkeditem mix '+ lines[l][0].substring(0,1).toLowerCase() +'  " data-video="' + lines[l][7] + '" data-co="' + lines[l][6] + '" data-info="'+lines[l][5] +', Died on ' + lines[l][3].substring(6,8)+"/"+lines[l][3].substring(4,6)+"/"+lines[l][3].substring(0,4) + ' From ' + lines[l][6] +' at age 27 and ' + lines[l][4] + ' Days <br>' + FBShare + '" img-info="' + lines[l][8] + '" video-id="' + lines[l][7] + '" data-name="' + lines[l][1] + '" data-year="' + lines[l][3] + '"  data-dtl="' + lines[l][4] + '" id="count' + l + '" >'+lines[l][2]+'<span class="blanktitle uppertitlesconst">-</span><span class="yeartitle uppertitles">' + lines[l][1] + '</span><span class="dtltitle uppertitles">' + lines[l][2] + ' days</span><span class="cotitle uppertitles">' + lines[l][2] + '</span></li>');
